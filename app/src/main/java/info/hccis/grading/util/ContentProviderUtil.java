...
public class ContentProviderUtil {
            ...
            if (calendarToUse < 0) {
                ...
                if (cursor != null && cursor.moveToFirst()) {
                    ...
                    for (int i = 0; i < calNames.length; i++) {
                        ...
                        Log.d("BJM calendars","id="+calIds[i]+" name="+calNames[i]);
                        cursor.moveToNext();
                    }
                    ...
                    builder.setSingleChoiceItems(calNames, -1, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Log.d("bjm chose calendar","cal="+calendarToUse+" name="+calNames[which]);
                            dialog.cancel();
                        }
    ...
    public static long createEvent(Activity activity, int calendarToUse, String description, String title) {
        //******************************************************************************
     ...
     * @since 2022-02-10
     */
    public static void createCalendarEventIntent(Activity activity, Object object, String title) {
        ...
        newIntent.putExtra(CalendarContract.Events.TITLE, title);
        //send number of tickets to event description
        newIntent.putExtra(CalendarContract.Events.DESCRIPTION, object.toString());
