...
import info.hccis.grading.MainActivity;
import info.hccis.grading.adapter.CustomerAdapterGrading;
import info.hccis.grading.entity.GradingAssessmentTechnical;
import info.hccis.grading.notification.NotificationApplication;
import info.hccis.grading.notification.NotificationUtil;
...
public class GradingListFragment extends Fragment implements CustomerAdapterGrading.GradingAssessmentChosenListener{
    ...
    public static void notifyDataChanged(String message) {
        ...
        try {
            ...
            Log.d("jj api", "Exception when trying to notify that the data set as changed");
        }
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        if(gradingArrayList != null)
            Log.d("JJ list loaded","List loaded from view model size:"+gradingArrayList.size());
    ...
    public void onGradingAssessmentClick(GradingAssessmentTechnical gat) {
        Log.d("JJ row clicked","Clicked a row for student name = "+gat.getStudentName());
        Log.d("JJ row clicked","Clicked a row for assessment data= "+gat.getAssessmentDate());
        Log.d("JJ row clicked","Clicked a row for numeric grade = "+gat.getNumericGrade());
